...
function createMenuItem(name, cost, category) {
  (this.name = name), (this.cost = cost), (this.category = category);
}
console.log((newMenu = new createMenuItem("tuna", 10, "lunch")));

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */

console.log((newMenu = new createMenuItem("Pancakes", 5, "Breakfast")));
console.log(
  (newMenu = new createMenuItem("turkey and cheese sub", 14, "lunch"))
);
console.log((newMenu = new createMenuItem("Curry chicken", 18, "dinner")));
...
console.log(
  newRating(
    "Ivy",
    4.0,
    "This place was pretty average. Clean, nice employees, and fast what more could you want"
  )
);
